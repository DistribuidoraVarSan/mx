...
export type Dictionary = {
  ...
  portal: {
    ...
    accountDeactivatedSuccess: string;
    ...
    storageUsage: string;
    storageEstimateNote: string;
    storageLocalStorage: string;
    storageSessionStorage: string;
    storageCookies: string;
    storageCookiesNote: string;
    storageIndexedDb: string;
    storageCacheStorage: string;
    storageServiceWorker: string;
    storageAvailable: string;
    storageUnavailable: string;
    storageClearBtn: string;
    storageConfirmClear: string;
    storageClearedSuccess: string;
    resourcesTitle: string;
    resourcesSubtitle: string;
    resourcesVersionLabel: string;
    resourcesVersionValue: string;
    resourcesHelpCenter: string;
    resourcesFaq: string;
    resourcesReportBug: string;
    resourcesContactSupport: string;
    resourcesSupportChannels: string;
    bugReportTitle: string;
    bugReportIntro: string;
    bugReportProblemTitle: string;
    bugReportProblemDesc: string;
    bugReportSteps: string;
    bugReportExpected: string;
    bugReportSeverity: string;
    bugReportSeverityLow: string;
    bugReportSeverityMedium: string;
    bugReportSeverityHigh: string;
    bugReportSeverityCritical: string;
    bugReportMetadataNotice: string;
    bugReportSubmit: string;
